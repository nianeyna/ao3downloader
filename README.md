...
As of <!--CHECK-->September 1, 2022<!--updatethis--> I have updated the script to take advantage of an ao3 code change which allows the script to interact with their rate limit more effectively. See the [Notes](#notes) section for details!
